      ...
      <section className="py-24">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          ...
          >
            ...
            Go, Java, JavaScript, TypeScript 기반으로 API 설계·구현, 인증/권한, 파일 업로드, 실시간 데이터 처리 등 제품의 핵심 기능을 구현해왔고, 운영 환경에서 안정적으로 동작하도록 성능과 신뢰성을 지속적으로 개선해왔습니다. 또한 기획·디자인·퍼블리셔와의 협업 경험을 바탕으로 사용자 요구를 빠르게 반영하고, 반복 작업은 자동화/도구화를 통해 개발 효율을 높입니다. AWS 환경과 온프레미스(Ubuntu) 환경 모두에서 배포·운영을 경험했으며, 낯선 기술도 빠르게 익혀 팀에 공유하고 더 나은 방향을 위해 적극적으로 개선안을 제시하는 개발자입니다.
            </p>
          </motion.div>
        </div>
      </section>
