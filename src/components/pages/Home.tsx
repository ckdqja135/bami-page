      ...
      <section className="py-24">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <br /><br />
            Go, Java, JavaScript, TypeScript 기반으로 다채널 데이터 집계·통계 분석, 실시간 데이터 처리, 외부 API 연동, 배치 스케줄링 자동화 등 제품의 핵심 기능을 설계·구현해왔고, 운영 환경에서 안정적으로 동작하도록 성능과 신뢰성을 지속적으로 개선해왔습니다.
            <br /><br />
            그리고 기획, 디자인, 퍼블리셔는 물론 프론트엔드, 백엔드 개발자와의 협업 경험을 바탕으로 요구사항을 빠르게 이해하고 반영하며 반복적인 작업은 자동화하여 효율적인 개발 환경을 만들어갑니다. AWS 환경과 온프레미스(Ubuntu) 환경 모두에서 배포·운영을 직접 담당했으며, AI 도구를 개발 워크플로우에 적극 활용하는 것은 물론 로컬 AI 모델·LLM·임베딩 시스템 등을 실제 프로젝트에 직접 적용하며 서비스 가치를 높여왔습니다.
            <br /><br />
